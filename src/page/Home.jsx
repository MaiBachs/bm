    ...
    <div className="mx-auto bg-white">
      <div className="py-1 grid grid-cols-6 gap-3 mt-8">
        <div className="p-5 col-span-6 rounded-sm shadow-lg flex justify-center bg-gray-100">
          {" "}
          <FaUserFriends style={{fontSize: 60, marginTop: -17, marginRight:10}}/>
      ...
      <div className="mt-3 p-1 grid grid-cols-6 gap-5 justify-center">
        ...
        <div className="col-span-2">
          <Link
            ...
            className="p-5 mt-3 rounded-sm shadow-lg flex justify-start bg-gray-100 no-underline"
          >
            <FaMoneyCheckAlt style={{fontSize: 40, marginTop:-7, marginRight:10}}/>
            Tổng tiền GD LNH :{home.moneyExternalTransaction.toLocaleString('en-US', {style: 'decimal', useGrouping: true})}
          </Link>
        </div>
        <div className="col-span-2">
          <Link
          ...
          >
            <FaMoneyCheckAlt style={{fontSize: 40, marginTop:-7, marginRight:10}}/>
            Tổng tiền GD NB :{home.moneyInternalTransaction.toLocaleString('en-US', {style: 'decimal', useGrouping: true})}
          </Link>
        </div>
        <div className="col-span-2">
          <Link
            ...
            className="p-5 mt-3 rounded-sm shadow-lg flex justify-start bg-gray-100 no-underline"
          >
            <AiFillIdcard style={{fontSize: 40, marginTop:-7, marginRight:10}}/>
